        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex space-x-8">
              ...
              <Link href="/contact" className="text-gray-900 px-3 py-2 text-sm font-medium">
                Contact
              </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions or need support? We're here to help you make the most of Grade Central.
          </p>
        </div>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">support@gradecentral.com</p>
