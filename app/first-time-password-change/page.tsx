          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <div className="mb-6">
                ...
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Password Changed Successfully!</h2>
              ...
              <div className="space-y-4">
                <Link
                  href="/login"
                  className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-md transition-colors focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 outline-none"
                >
                  Go to Login Now
                </Link>
              </div>
